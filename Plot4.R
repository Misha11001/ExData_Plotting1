...
var6<-as.numeric(as.character(data$Voltage))
var7<-as.numeric(as.character(data$Global_reactive_power))
...
plot(data$Time, var6, type = "l", col = "black", 
...
plot(data$Time, var7, type = "l", col = "black", 
